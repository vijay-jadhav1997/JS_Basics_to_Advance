...
createElement('Math.max(x,y,z)', 'Return the maximum value among x, y & z.','Math.max(25, 10, 40, 5)', Math.max(25, 10, 40, 5), 'numbers = [20, 50, 5, -10, 525], Math.max(...numbers)', Math.max(...numbers));
